...
const modelName = 'new-platform-flexberry-service-bus-subscription-statistics-monitor';

moduleForModel(modelName, `Unit | Serializer | ${modelName}`, {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-service-bus-subscription-statistics-monitor',
    'transform:file',
    'transform:decimal',
