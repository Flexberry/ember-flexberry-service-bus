...
const modelName = 'new-platform-flexberry-service-bus-statistics-compression-setting';

moduleForModel(modelName, `Unit | Serializer | ${modelName}`, {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-service-bus-statistics-compression-setting',
    'transform:file',
    'transform:decimal',
