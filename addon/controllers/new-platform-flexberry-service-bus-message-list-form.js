...
export default ListFormController.extend({
  /**
    ...
    @type String
    @default 'new-platform-flexberry-service-bus-message-edit-form'
  */
  editFormRoute: 'new-platform-flexberry-service-bus-message-edit-form',

  getCellComponent(attr, bindingPath) {
    let cellComponent = this._super(...arguments);
    if (bindingPath === 'isSending') {
      cellComponent.componentName = 'flexberry-checkbox';
      cellComponent.componentProperties = { readonly: true };
    } else if (bindingPath === 'sendingTime' || bindingPath === 'receivingTime') {
